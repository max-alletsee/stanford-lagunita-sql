---
title: 'SQL Exercise #4: Querying Social Data, Extra Exercises - Solutions with Code'
output:
  html_document:
    df_print: paged
---

This notebook contains the **solutions with code** for Exercise 4 - Querying Social Data, Extra Exercises.
